...
def place_stoploss_zerodha(trading_symbol, transaction_type, trade_type, strike_price, index, limit_prc, broker='zerodha'):
    # filepath = "Utilities/Siri.json"
    # user_details = load_credentials(filepath)
    ...
    # with open(filepath, 'w') as file:
    #     json.dump(user_details, file, indent=4)  # Save the updated user_details back to json file
    return (trading_symbol, transaction_type, trade_type, strike_price, index, limit_prc)


def place_stoploss_aliceblue(trading_symbol, transaction_type, trade_type, strike_price, index, limit_prc, broker='aliceblue'):
    # filepath = "Utilities/Siri.json"
    # user_details = load_credentials(filepath)
    # trigger_prc = limit_prc+1
