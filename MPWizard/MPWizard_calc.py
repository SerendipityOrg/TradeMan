...
def get_option_tokens(base_symbol, expiry_date, option_type,strike_prc):
    instrument_path = os.path.join("Utils","instruments.csv")
    instruments_df = pd.read_csv("/Users/amolkittur/Documents/TradeMan/Utils/instruments.csv")

    instruments_df = instruments_df[
        ["instrument_token", "tradingsymbol", "name", "exchange", "lot_size", "instrument_type", "expiry", "strike"]
    ]

    print("inside",base_symbol, expiry_date, option_type, strike_prc)
