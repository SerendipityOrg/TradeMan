...
def place_zerodha_order(trading_symbol, transaction_type, trade_type, strike_price, broker='zerodha'):
    ...
    for user in user_details[broker]:
        ...
        qty = user_details[broker][user]['qty']
...
def place_aliceblue_order(trading_symbol, transaction_type, trade_type, strike_price, broker='aliceblue'):
    filepath = "Utilities/AmiPy.json"
    user_details = load_credentials(filepath)
