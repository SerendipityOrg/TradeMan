...
cred = credentials.Certificate(r"C:\Users\vanis\OneDrive\Desktop\Serendipity trading firm\App\credentials.json")
...
def save_to_firebase(user, excel_path):
    ...
    print(f"Data uploaded to {destination_path} in the Firebase Realtime Database")
