...
def get_tokens(base_symbol, expiry_date, option_type, strike_prc=0):
    ...
    for token, single_trading_symbol in zip(tokens, trading_symbols):
        trading_symbols_aliceblue.append(Instrument("NFO", token, base_symbol, single_trading_symbol, expiry_date, 40))
