...
def place_zerodha_order(trading_symbol, transaction_type, trade_type, strike_price, index, qty, users, broker='zerodha'):
...
def place_aliceblue_order(trading_symbol, transaction_type, trade_type, strike_price, index, qty, users, broker='aliceblue'):
    filepath = os.path.join(parent_dir, 'Utils', 'users', f'{users}.json')
    if not os.path.exists(filepath):
        print("file not exist")
        return
...
def place_stoploss_zerodha(trading_symbol, transaction_type, trade_type, strike_price, index, limit_prc, qty, users, broker='zerodha'):
    filepath = os.path.join(parent_dir, 'Utils', 'users', f'{users}.json')
    if not os.path.exists(filepath):
        print("file not exist")
        return
...
def place_stoploss_aliceblue(trading_symbol, transaction_type, trade_type, strike_price, index, limit_prc, qty, users, broker='aliceblue'):
    filepath = os.path.join(parent_dir, 'Utils', 'users', f'{users}.json')
    if not os.path.exists(filepath):
        print("file not exist")
        return
