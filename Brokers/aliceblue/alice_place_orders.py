...
alice = Aliceblue("BY1424","a9bkSpfZn6x24iWvh1L8epG464l2OqZJIpc4gzWOOmKSacMCtmZtTn8W328rqd1KVzDBPP3M50Frhy0cCnCk272E1z1CrosIAlTD")
alice.get_session_id()
print(alice)
print(alice.modify_order(transaction_type = TransactionType.Sell,
                    instrument = Instrument(exchange='NFO', token=11521538, symbol='NIFTY', name='NIFTY2390719450CE', expiry="2023-09-07", lot_size=50),
                    order_id= '230901000265466',
                    quantity = 50,
                    order_type = OrderType.StopLossLimit,
                    product_type = ProductType.Intraday,
