...
ALICEBLUE_BROKERAGE = 15
STT_ON_EXERCISE_RATE = 0.125 / 100
STT_ON_SELL_RATE = 0.0625 / 100
TRANSACTION_CHARGES_RATE = 0.05 / 100
SEBI_CHARGES_RATE = 10 / 10000000
GST_RATE = 18 / 100
STAMP_CHARGES_RATE = 0.003 / 100
FUTURES_BROKERAGE_RATE = 0.03 / 100
FUTURES_STT_CTT_RATE = 0.0125 / 100
FUTURES_TRANSACTION_CHARGES_RATE = 0.0019 / 100
FUTURES_SEBI_CHARGES_RATE = 10 / 100000000
FUTURES_STAMP_CHARGES_RATE = 0.002 / 100
# Constants
ZERODHA_BROKERAGE = 20
ALICEBLUE_BROKERAGE = 15
STT_ON_EXERCISE_RATE = 0.125 / 100
...
def aliceblue_taxes(qty, entry_prc, exit_prc, orders):
    if orders == 1:
        ...
        instruments = 4
    # Brokerage
    brokerage = ALICEBLUE_BROKERAGE * instruments  # Flat Rs. 15 per executed order
